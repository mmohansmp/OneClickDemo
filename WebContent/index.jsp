...
<head>
    ...
    <title>One Click Deployment Demo to Rishi!</title>
                ...
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="https://github.com/mmohansmp/OneClickDemo" class="btn btn-default btn-lg"><i class="fa fa-github fa-fw"></i> <span class="network-name">Github</span></a>
                            </li>
							<li>
